...
constexpr int   kPanelH      = 314;  // 300 + the footer note line (F5, UX audit 2026-08-29)
constexpr int   kPanelHCompact = 234; // View-tab Compact mode: hero plot hidden, knobs reflow to a 4-col grid
constexpr int   kDynFooterNoteH = 14; // Dynamics footer: one line above the Apply row saying what Apply does
